...
# ---- Model ----
MODEL_NAME="Qwen/Qwen3-1.7B"              # Model name or path (Hugging Face format, e.g. Qwen/Qwen3-0.6B)

# ---- Quantization ----
QUANT_CONFIG="W2.79A8KV8"                 # W1.58A8KV8 | W1.88A8KV8 | W2.79A8KV8 | W4A8KV8
TRAIN_YAML="train"                        # Config file: ./train.yaml  (change to train_1, train_2, ...)

# ---- Experiment ----
RUN_NAME="qwen3-1.7b_w2.79a8kv8"          # Experiment tag (written to config.py)
