#!/bin/bash
# ============================================================================
# MobileLLM-350M Template Generator
# ============================================================================
# Generates all W*A8KV8 template directories from:
#   1. Template/                — custom .py files + base config.json (with placeholder)
#   2. facebook/MobileLLM-ParetoQ-350M-BF16 (HF) — tokenizer, generation_config, README, LICENSE
#
# Output directories:
#   MobileLLM-350M-W1.58A8KV8-Template/
#   MobileLLM-350M-W1.88A8KV8-Template/
#   MobileLLM-350M-W2.79A8KV8-Template/
#   MobileLLM-350M-W4A8KV8-Template/
#
# Usage:
#   bash generate_mobilellm-350m_template.sh
# ============================================================================
...
MODEL_NAME="MobileLLM-350M"                    # Used for output directory naming
HF_MODEL_ID="facebook/MobileLLM-ParetoQ-350M-BF16"            # HuggingFace model ID
...
QUANT_VARIANTS=(
    "W1.58A8KV8|w1_58a8kv8_embint4_mobilellm"
    "W1.88A8KV8|w1_88a8kv8_embint4_mobilellm"
    "W2.79A8KV8|w2_79a8kv8_embint4_mobilellm"
    "W4A8KV8|w4a8kv8_mobilellm"
)
...
echo "================================================================================"
echo "MobileLLM-350M Template Generator"
echo "================================================================================"
echo "Model:           ${HF_MODEL_ID}"
echo "Variants:        ${#QUANT_VARIANTS[@]} (W1.58, W1.88, W2.79, W4)"
echo "Template base:   ${TEMPLATE_BASE}"
echo "HF cache:        ${HF_CACHE_DIR}"
echo "================================================================================"
echo ""

if [ ! -f "${HF_CACHE_DIR}/tokenizer.model" ]; then
...
for entry in "${QUANT_VARIANTS[@]}"; do
    ...
    echo "    ├── configuration_llama.py"
    echo "    ├── modeling_llama.py"
    echo "    ├── tokenizer_config.json"
    echo "    ├── tokenizer.model"
    echo "    ├── special_tokens_map.json"
    echo "    ├── tokenization_llama.py"
    echo "    ├── tokenization_llama_fast.py"
