#!/bin/bash
# ============================================================================
# Qwen3-0.6B Template Generator
# ============================================================================
# Generates all W*A8KV8 template directories from:
#   1. Template/                — custom .py files + base config.json (with placeholder)
#   2. Qwen/Qwen3-0.6B (HF)    — tokenizer, generation_config, README, LICENSE
#
# Output directories:
#   Qwen3-0.6B-W1.58A8KV8-Template/
#   Qwen3-0.6B-W1.88A8KV8-Template/
#   Qwen3-0.6B-W2.19A8KV8-Template/
#   Qwen3-0.6B-W2.79A8KV8-Template/
#   Qwen3-0.6B-W4A8KV8-Template/
#
# Usage:
#   bash generate_qwen3-0.6b_template.sh
# ============================================================================
...
MODEL_NAME="Qwen3-0.6B"                    # Used for output directory naming
HF_MODEL_ID="Qwen/Qwen3-0.6B"              # HuggingFace model ID
...
echo "================================================================================"
echo "Qwen3-0.6B Template Generator"
echo "================================================================================"
