...
class Qwen3Config(PretrainedConfig):
    ...
    def to_dict(self):
        ...
        Excludes the EdgeRazor runtime object from serialization.
        """
        output = super().to_dict()
        # Remove non-serializable EdgeRazor objects
        if "edgerazor_config" in output:
            del output["edgerazor_config"]
        return output
