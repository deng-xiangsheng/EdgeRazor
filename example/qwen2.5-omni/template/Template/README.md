...
### 🤗  Transformers Usage integrated with EdgeRazor for Quantization

- import from local module
```python
import sys
sys.path.insert(0, "/path/to/qwen2_5_omni_7B_edgerazor")

from modeling_qwen2_5_omni import Qwen2_5OmniForConditionalGeneration

model_path = "/path/to/qwen2_5_omni_7B_edgerazor"
...
from qwen2_5_omni_7B_edgerazor import Qwen2_5OmniForConditionalGeneration
