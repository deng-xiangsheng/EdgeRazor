...
# TODO Apart from customized class (Qwen2_5OmniForConditionalGeneration), import all attention classes to make them available for the model.
...
class Qwen2_5OmniForConditionalGeneration(Qwen2_5OmniPreTrainedModel, GenerationMixin):
    ...
    greetings = "Initializing Local Qwen2_5OmniForConditionalGeneration Quantized Model by EdgeRazor."
